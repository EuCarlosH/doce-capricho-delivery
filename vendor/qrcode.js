/*
 * QR encoder derived from Kazuhiko Arase's QRCode for JavaScript.
 * Copyright (c) 2009 Kazuhiko Arase. MIT License.
 * Bundled locally for the Doce Capricho PIX checkout.
 */
(function (global) {
'use strict';
...
function render(container, text) {
  ...
  svg.setAttribute('aria-label', 'QR Code PIX');
  ...
  path.setAttribute('fill', '#15100C');
  svg.appendChild(path);
  container.appendChild(svg);
  return svg;
}
global.DCAPixQRCode = { render: render };
